    ...
    OmniWearDevice (final MainActivity activity, final OmniWearBluetoothService btService) {
        ...
        activity.findViewById(R.id.button_front).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(FRONT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_front_right).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(FRONT_RIGHT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_right).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(RIGHT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_back_right).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(BACK_RIGHT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_back).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(BACK), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_back_left).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(BACK_LEFT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_left).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(LEFT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_front_left).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(FRONT_LEFT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_middle_front).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(MID_FRONT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_middle_right).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(MID_RIGHT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_middle_back).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(MID_BACK), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_middle_left).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(MID_LEFT), mIntensity); }
                return false;
            }
        });
        activity.findViewById(R.id.button_top).setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) { btService.commandMotor(motor(TOP), mIntensity); }
                return false;
            }
        });
    }
